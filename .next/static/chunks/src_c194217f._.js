...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/cartStore.ts [app-client] (ecmascript)");
'use client';
;
;
;
...
const ProductCard = ({ product })=>{
    const handleAddToCart = (e)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cartStore"].addToCart(product, 1);
        // Dispatch custom event to update cart count
        window.dispatchEvent(new Event('cartUpdated'));
        // Show a simple notification (you could replace this with a toast)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "group hover:shadow-lg transition-shadow duration-200 h-full",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "font-semibold text-sm mb-2 line-clamp-2 group-hover:text-orange-500 transition-colors",
...
const products = [
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Headphones'
        ],
        features: [
            'Noise Cancellation',
            '30-hour Battery',
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Smart+Watch'
        ],
        features: [
            'Heart Rate Monitor',
            'GPS Tracking',
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=T-Shirt'
        ],
        features: [
            '100% Organic Cotton',
            'Machine Washable',
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Yoga+Mat'
        ],
        features: [
            'Non-slip Surface',
            'Extra Thick',
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Desk+Lamp'
        ],
        features: [
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Skincare+Set'
        ],
        features: [
            'All Skin Types',
            'Natural Ingredients',
    ...
    },
    {
        ...
        inStock: true,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Programming+Book'
        ],
        features: [
            'Multiple Languages',
            'Best Practices',
    ...
    },
    {
        ...
        inStock: false,
        images: [
            'https://via.placeholder.com/400x400/1f2937/ffffff?text=Gaming+Mouse'
        ],
        features: [
            'High Precision',
            'RGB Lighting',
...
const searchProducts = (query)=>{
    ...
    return products.filter((product)=>product.name.toLowerCase().includes(lowercaseQuery) || product.description.toLowerCase().includes(lowercaseQuery) || product.category.toLowerCase().includes(lowercaseQuery) || product.brand.toLowerCase().includes(lowercaseQuery));
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
function ProductsPage() {
    ...
    const [showInStockOnly, setShowInStockOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const processedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[processedProducts]": ()=>{
            let result = [
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"]
            ];
            // Apply search filter
            if (searchQuery.trim()) {
                result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchProducts"])(searchQuery);
            }
            // Apply category filter
            if (selectedCategory !== 'all') {
                result = result.filter({
                    "ProductsPage.useMemo[processedProducts]": (product)=>product.category.toLowerCase() === selectedCategory.toLowerCase() || product.category.toLowerCase().replace(' & ', '-').replace(' ', '-') === selectedCategory
                }["ProductsPage.useMemo[processedProducts]"]);
            }
            // Apply price range filter
            result = result.filter({
                "ProductsPage.useMemo[processedProducts]": (product)=>product.price >= priceRange.min && product.price <= priceRange.max
            }["ProductsPage.useMemo[processedProducts]"]);
            // Apply stock filter
            if (showInStockOnly) {
                result = result.filter({
                    "ProductsPage.useMemo[processedProducts]": (product)=>product.inStock
                }["ProductsPage.useMemo[processedProducts]"]);
            }
            // Apply sorting
            result.sort({
                "ProductsPage.useMemo[processedProducts]": (a, b)=>{
                    switch(sortBy){
                        case 'price-low':
    ...
    const handleSearch = (e)=>{
        e.preventDefault();
    // The search will be handled by the useMemo hook
    };
    const clearFilters = ()=>{
        setSearchQuery('');
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                    children: [
                                                        ...
                                                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categories"].map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                value: category.slug,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                            ...
                                            children: searchQuery ? `Search results for "${searchQuery}"` : 'All Products'
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/products/page.tsx",
                                            lineNumber: 171,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                " of ",
                                                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].length,
                                                " products"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/products/page.tsx",
...
_s(ProductsPage, "Lf5A6+x0VH7nvEm2Rzwxir4mdYE=", false, function() {
    return [
...
//# sourceMappingURL=src_c194217f._.js.map